# Group 6 → Group 7 Exact Annual Handoff Requirements

No raw Collector archive or rebuilt substitute is accepted. Group 7 requires these exact frozen SQLite artifacts:
...
The checker must reject substitutes, partial databases, rebuilt variants, and renamed files whose content does not match the expected hash.
