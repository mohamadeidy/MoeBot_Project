# MoeBot Group 13 — Policy Learning

**State:** PREPARATION ONLY — real execution is not authorized.

## Purpose
Learn candidate WAIT/BUY/SELL/HOLD/EXIT policy from frozen setup/outcome/discovery evidence.

## Hard exclusions
- live_execution
- final_holdout_tuning
- modify_frozen_upstream_rows
