...
class V3CrossYearTests(unittest.TestCase):
 def test_descriptive_count_drift_is_allowed(self):
  with tempfile.TemporaryDirectory() as td:
   ...
   fr={"status":"FROZEN_FOR_2024_OOS_V3","validated_commit":"c","annual_2023_manifest_hash":a23["manifest_hash"]};fr["manifest_hash"]=stable_hash(fr)
   a24={"status":"ANNUAL_2024_OOS_PASS","validated_commit":"c","freeze_manifest_hash":fr["manifest_hash"],"causality":"PASS","no_lookahead":"PASS","no_trading_outputs":True,"frozen_identity_drift":False,"oos_conditioned_semantic_changes":False,"stage6":{"table_row_counts":{"x":5}},"stage7":{"table_row_counts":{"y":9},"definition_coverage":{"d":9}}};a24["manifest_hash"]=stable_hash(a24)
   ...
   self.assertEqual(r["status"],"PASS");self.assertEqual(r["descriptive_counts"]["2024"]["stage6"]["x"],5)
