...
def validate(*,annual23_path:Path,annual24_path:Path,freeze_path:Path,output:Path)->dict[str,Any]:
 ...
 if a23.get("validated_commit")!=fr.get("validated_commit") or a24.get("validated_commit")!=fr.get("validated_commit"):fail.append("identity_drift:validated_commit")
 if not fr.get("oos_tooling_commit") or a24.get("oos_tooling_commit")!=fr.get("oos_tooling_commit"):fail.append("identity_drift:oos_tooling_commit")
