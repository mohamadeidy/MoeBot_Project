...
def _lineage_commits(annual:dict[str,Any],expected_commit:str)->tuple[str,str]:
 annual_commit=str(annual.get("validated_commit") or "")
 if not annual_commit:raise RuntimeError("Annual 2023 validated_commit missing")
 tooling_commit=str(expected_commit or "")
 if not tooling_commit:raise RuntimeError("OOS tooling commit missing")
 return annual_commit,tooling_commit
