...
def main():
 ...
 for g in GROUPS:
  ...
  if g=='group6':
   target_name=f'MoeBot_Group6_XAUUSD_{a.year}_v0.6.4_corrected_v3_group8_v1.sqlite'
  elif 'corrected_v3_group8_v1' not in src.name:
   target_name=f'{src.stem}_corrected_v3_group8_v1.sqlite'
  else:
 ...
 report={'format_version':2,'status':'PASS_PACKAGED','purpose':'Group8 coherent corrected-runtime-v3 annual dependencies Groups2-7','year':a.year,'repository':a.repository,'release_tag':a.tag,'lineage':'dukascopy_rebuild_v1_corrected_runtime_v3_group8_v1','runtime_engines':pipe['engines'],'source_sha256':pipe['source_sha256'],'group7_source_closure_tag':g7r['source_group7_closure_tag'],'group7_source_closure_commit_sha':g7r['source_group7_closure_commit_sha'],'group7_config_id':g7r['summary']['config_id'],'asset_naming_policy':'Group6 release identity is year-qualified; all annual package filenames are collision-safe across years','packages':packages}
